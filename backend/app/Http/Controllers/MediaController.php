...
class MediaController extends Controller
{
    ...
    private function findUsage(string $url): array
    {
        ...
        $mappings = [
            ...
            'kesemaptaan' => ['column' => 'photo', 'label' => 'Kesemaptaan (Foto)', 'nameColumn' => 'name'],
            'kesemaptaan_hero' => ['column' => 'hero_image', 'label' => 'Kesemaptaan (Hero)', 'nameColumn' => 'name'],
            'kesemaptaan_activities' => ['column' => 'photo', 'label' => 'Kegiatan Kesemaptaan', 'nameColumn' => 'title'],
            'kesemaptaan_instructors' => ['column' => 'photo', 'label' => 'Instruktur Kesemaptaan', 'nameColumn' => 'name'],
            'kesemaptaan_gallery' => ['column' => 'image', 'label' => 'Galeri Kesemaptaan', 'nameColumn' => 'title'],
