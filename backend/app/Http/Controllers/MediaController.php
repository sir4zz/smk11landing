...
class MediaController extends Controller
{
    ...
    private function findUsage(string $url): array
    {
        ...
        $mappings = [
            ...
            'osis_candidates_banner' => ['column' => 'banner_photo', 'label' => 'Kandidat OSIS (Foto Pasangan/Banner)', 'nameColumn' => 'name'],
            'osis_candidates' => ['column' => 'photo', 'label' => 'Kandidat OSIS (Foto Ketua)', 'nameColumn' => 'name'],
            'osis_candidates_wakil' => ['column' => 'wakil_photo', 'label' => 'Kandidat OSIS (Foto Wakil)', 'nameColumn' => 'wakil_name'],
