...
/**
 * Main Tenaga Kependidikan (tendik) record from the SDM module. Kept separate
 * from Guru records even though the structure is similar.
 */
class SdmTendik extends Model
{
    use HasUuids;

    public const STAFF_TYPE = 'tendik';
